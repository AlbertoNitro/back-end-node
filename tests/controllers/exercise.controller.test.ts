...
describe("POST /exercise", () => {
    it("should return: 201 - CREATED + Exercise", (done) => { // 1791
        const justificationInputDtos1: JustificationInputDto[] = [];
        const justificationInputDtos2: JustificationInputDto[] = [{"isCorrect" : false, "text" : "No murio en 1917"}, {"isCorrect" : false, "text" : "No murio en 1927"}];
        const solutionInputDtos: SolutionInputDto[] = [{"isCorrect" : true, "text" : "1791", "justifications": justificationInputDtos1}, {"isCorrect" : false, "text" : "1719", "justifications": justificationInputDtos2}];
        const exerciseInputDto: ExerciseInputDto = {"lessonId": "1234", "formulation": "¿En que año murio Amadeus Mozart?", "solutions": solutionInputDtos};
...
describe("PUT /exercise/:id", () => {
    it("should return: 200", (done) => {
        const exerciseId = "851d87b8b230cf25177998c0";
        const exerciseInputDto: ExerciseInputDto = {"formulation": "¿En que año se descubrio pluton?", "solutions": []};
