...
export class RelationController {
    ...
    async findAll(req: Request, res: Response): Promise<any> {
        ...
        const relationsOutputDtos: RelationOutputDto[] = this.converterModelsToDtosService.toArrayRelationOutputDto(relations);
    ...
    async create(req: Request, res: Response): Promise<any> {
        ...
        const relationOutputDto: RelationOutputDto = this.converterModelsToDtosService.toRelationOutputDto(relation);
