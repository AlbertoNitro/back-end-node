...
export class SessionController {
    ...
    async create(req: Request, res: Response): Promise<any> {
        ...
        const sessionOutputDto: SessionOutputDto = this.converterModelsToDtosService.toSessionOutputDto(session);
    ...
    async update(req: Request, res: Response): Promise<any> {
        ...
        if (session) {
            ...
            const lessonOutputDto: SessionOutputDto = this.converterModelsToDtosService.toSessionOutputDto(session);
